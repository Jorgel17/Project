...
public class AddUser extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ModulLagrer at " + "NEJ" + "</h1>");
            ...
            conn = dbTool.login(out);
            
           // userTool.newUser(firstName,lastName,out,conn);
            
            
            if (valg.contains("Ny"))
                    userTool.newUser(firstName, lastName, out, conn);
            userwriter.skrivStudentForm(snr, firstName, lastName, out);                
